...
for i in vrijeme_period: #Ne mora nužno konvergirat period s jedne strane svakim korakom prema analitičkom periodu jer je postoji greška u razmaku između mijenjanja 2 predznaka
    p1.graf_period(i)
plt.xlabel('T[s]')
plt.ylabel('A[m]')
